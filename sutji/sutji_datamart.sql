//1. GROSS REVENUE TOTAL PER HARI
CREATE OR REPLACE TABLE SUTJI_DM_TOTAL_GR_PER_DATE
AS
...
//2. GROSS REVENUE PER PRODUCT PER MONTH
CREATE OR REPLACE TABLE SUTJI_DM_TOTAL_GR_PER_PRODUCT_PER_MONTH
AS
...
//3. TOTAL PEMBELIAN PER PRODUCT PER MONTH
CREATE OR REPLACE TABLE SUTJI_DM_TOTAL_ORDER_PER_PRODUCT_PER_MONTH
AS
...
//4. TOTAL PEMBELIAN PER KATEGORI PRODUCT PER MONTH
CREATE OR REPLACE TABLE SUTJI_DM_TOTAL_ORDER_PER_CATEGORY_PER_MONTH
AS
...
//5. TOTAL PEMBELIAN PER COUNTRY PER MONTH
CREATE OR REPLACE TABLE SUTJI_DM_TOTAL_ORDER_PER_COUNTRY_PER_MONTH
AS
